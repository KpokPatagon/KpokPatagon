...
using KpokPatagon.I18n;
using KpokPatagon.Messaging;
using System;

namespace KpokPatagon.Multitenancy.Commons
{
    /// <summary>
    ...
    public class MailServer : DataModel, IEquatable<MailServer>, ISmtpServerConfiguration
    {
        ...
        public MailServer(string id, int tenantId)
        {
            Id = id;
            TenantId = tenantId;
        }
        ...
        /// </summary>
        [PartitionKey]
        [IntegerDataProperty("TenantId", DbType.Integer, FieldName = "_tenantId", PrimaryKey = 2, DefaultValue = 0)]
        public int TenantId
        {
            ...
            {
                _tenantId = value;
                NotifyPropertyChanged(_tenantId);
            }
        }
